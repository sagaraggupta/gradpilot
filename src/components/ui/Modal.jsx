...
export default function Modal({ isOpen, onClose, title, children }) {
  ...
  return (
    // 👇 FIX: Changed z-50 to z-[100] to guarantee it sits above everything
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-[fadeIn_0.2s_ease-out]">
      ...
      {/* 👇 FIX: Added relative z-[101] to the inner box just to be absolutely bulletproof */}
      <div className="relative z-[101] bg-[#0d0d14] border border-white/10 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
